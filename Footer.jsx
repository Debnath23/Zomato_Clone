...
function Footer() {
    return (
        ...
        <div className="grid grid-cols-4 mt-[30px] px-[200px] pt-10">
            <div className='text-lg '>
                <nav>
                    <h6 className='font-semibold text-2xl my-3'>ABOUT ZOMATO</h6>
                    <a href="#" >
            ...
            <div className='text-lg '>
                <nav>
                    <h6 className='font-semibold text-2xl my-3'>ZOMAVERSE</h6>
                    <a href="#" >
            ...
            <div className='text-lg '>
                <nav>
                    <h6 className='font-semibold text-2xl my-3'>FOR RESTAURANTS</h6>
                    <a href="#" >
            ...
            <div className='text-lg '>
                <nav>
                    <h6 className='font-semibold text-2xl my-3'>LEARN MORE</h6>
                    <a href="#" >
